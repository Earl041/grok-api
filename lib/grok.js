...
async function launchBrowser() {
  // FIX 1: Set AWS Lambda runtime supaya @sparticuz/chromium extract libraries betul
  process.env.AWS_LAMBDA_JS_RUNTIME = 'nodejs22.x';
  
  // Wajib set sebelum launch — supaya chromium tahu mode
  chromium.setHeadlessMode = true;
  
  // FIX 2: setGraphicsMode mesti sebagai function call, bukan property assignment
